...
export const COMMON_MESSAGE = {
  ...
  SOCIETY_LEVEL_DELETE_FAIL: "Failed to delete society level",
  ...
  PACKAGE_TIER_MAPPING_DELETE_SUCCESS:
    "Package-tier mapping deleted successfully",
  PACKAGE_TIER_MAPPING_DELETE_FAIL:
    "Failed to delete package-tier mapping details",

  PACKAGE_SERVICE_MAPPING_FETCH_FAIL:
    "Failed to fetch package-service mapping details",
  PACKAGE_SERVICE_MAPPING_SAVE_SUCCESS:
    "Package-service mapping saved successfully",
  PACKAGE_SERVICE_MAPPING_SAVE_FAIL:
    "Failed to save package-service mapping details",
  PACKAGE_SERVICE_MAPPING_DELETE_SUCCESS:
    "Package-service mapping deleted successfully",
  PACKAGE_SERVICE_MAPPING_DELETE_FAIL:
    "Failed to delete package-service mapping details",
  ...
  CATEGORY_SERVICE_MAPPING_ADDED: "Service mapping created successfully",
  CATEGORY_SERVICE_MAPPING_UPDATED: "Service mapping updated successfully",
  ËRROR_MESSAGE: "Something went wrong. Please try again.",
};
...
export const REGEX_MSG = {
  ...
  DURATION_DAYS: "Duration must be a whole number greater than 0",
  PRICE: "Price must be greater than 0",
  TRIAL_DAYS: "Trial Days must be greater than 0",
};
...
export const GEN_CODE_SERVICE_CATEGORY = "SERVICE_CATEGORY";

export const BILLING_DURATION_MAP: Record<string, number> = {
  MONTHLY: 30,
  QUARTERLY: 120,
  YEARLY: 365,
};
...
export const levelConfig: Record<
  number,
  { bg: string; border: string; chip: string; chipText: string; dot: string }
> = {
  1: {
    bg: "#ffffff",
    border: "#c7d7fd",
...
export const CORAL_LIGHT = "#FF8A8E";
export const CORAL_DARK  = "#E03E43";
export const PEACH       = "#FFF0F0";

export const gradientBg = `linear-gradient(135deg, ${CORAL} 0%, ${CORAL_LIGHT} 100%)`;
