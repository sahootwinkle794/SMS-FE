...
import { Feature, Service, FAQ, NavLink, ContactInfo, SocialLink, FooterSection } from '../types';
...
export const FEATURES: Feature[] = [
  {
    ...
    description:
      `Every user's different—so you have three seamless ways to manage your society: Web Portal, Mobile App, or Kiosk. Each one tailored to make operations easier, faster, and better for you.`,
  },
  {
    icon: IconClock,
